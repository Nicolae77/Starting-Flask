const quizData =[
    ...
    },
    {
     ...
     {
        question: "Under Microsoft Azure's Shared Responsability Model, who manages virtual network security for Software-as-a-Service(SaaS) solution in Azure cloud?",
     ...
     {
        question: "Azure Policy focuses on enforcing organizational standards on Azure _____ .",
         a: "resources",
         b: "users",
         C: "groups",
         d: "costs",
     ...
     {
        question: "If organization wants to store data that only a specific virtual machine needs to access, which storage service should they use?",
     ...
     {
        question: "Which of the following statements about Azure cost and VM management is true?",
     ...
     {
        question: "Which of the following actions are possible when using Azure Storage Explorer?",
     ...
     {
        question: "Using automation to produce consistent and repeatable results is an example of _____ .",
         a: "reliability",
         b: "security",
         C: "predictability",
     ...
     {
        question: "In Azure ExpressRoute, if you want to connect multiple sites to the same virtual network, you can set up a VPN device at each location and connect them all to the same VPN gateway. This is known as a _____ .",
     ...
     {
        question: "The Platform-as-a-Service(PaaS) model is ideal for which use case?",
     ...
     {
        question: "How is traffic routed between virtual machines in peered virtual network?",
     ...
     {
        question: "An organization is planning to move to the cloud and is concerned about the security of its data. According to the shared responsibility model, how are security obligations assigned?",
     ...
     {
        question: "You need to send secure emails and documents outside of your company. Which Azure service should you use?",
     ...
     {
        question: "What benefit is provided by deploying an application's Azure-hosted resource into multiple Azure availability zones?",
         a: "Increase security",
     ...
     {
        question: "Azure Virtual Desktop non-persistent environment using ephemeral disk are ideal for ____ applications, which are tolerant of individual virtual machine failure.",
         a: "stateless",
         b: "data-centric",
         C: "distributed",
         d: "user-centric",
     ...
     {
        question: "You could structure Azure your subscription by _____ in order to limit one team to lower-cost resources while allowing the IT department a full range.",
         a: "environment",
         b: "billing",
     ...
     {
        question: "Which choice is an example of resizing an Azure virtual machine?",
     ...
     {
        question: "You need to view and update the Microsoft Defender for Cloud permissions. To which role you be assigned?",
         a: "Security Reader",
     ...
     {
        question: "Which Azure product helps you compare how much your current workloads cost in your on-premises environment with how much they would cost in Azure?",
         a: "Advisor",
     ...
     {
        question: "Your manager has approached you with a request to reduce Azure storage cost in your department, and asks you if changing storage tiers from hot to cool would help. What key consideration should you inform him about when performing this change?",
     ...
     {
        question: "When considering the availability options for Azure Virtual Machine, what is the difference between an update domain and a fault domain?",
     ...
     {
        question: "You can use _____ in Azure to provide a scalable way to run applications on a set of virtual machines(VMs)",
     ...
     {
        question: "Regarding Azure Storage, which one of the following options for replicating the data in your storage account offers replicated data three times within a single region, and data is also replicated asynchronously to a second region hundreds of miles away from the primary region?",
     ...
     {
        question: "Your organization has moved its operations to Azure cloud and wants to ensure that it enforces Zero Trust security principles. Which of the following is an example of how the organization can enforce the Zero Trust principle?",
     ...
     {
        question: "Which Azure App Service pricing tier allows you to run your apps in a private, dedicated environment in an Azure datacenter?",
     ...
     {
        question: "_____ refers to ability of your application to meet the commitments you make to your customers",
         a: "Security",
         b: "Reliability",
     ...
     {
        question: "Many cloud services are _____ because they allow you to increase or decrease the number of resources with minimum friction.",
         a: "elastic",
         b: "fault-tolerant",
         C: "high available",
         d: "shared tenancy",
     ...
     {
        question: "An organization plans to migrate its existing on-premises web servers to Azure cloud. They want to control and access web server, operating systems and install proprietary development tools, database management systems, business analytics software on these servers. Which cloud deployment model should they implement?",
         a: "Serverless",
         b: "IaaS",
         C: "PaaS",
         d: "SaaS",
     ...
     {
        question: "Your organization wants to store data for its on-premise applications on Azure. They want to accomplish this with minimal cost in IT resource and administration. What action should your business take to best meet their needs?",
